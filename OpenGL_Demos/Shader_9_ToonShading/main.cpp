...
void SetupRC(void)
    ...
    toonShader = gltLoadShaderPairWithAttributes("/Users/mpm/OpenGL-OpenGLES/OpenGL_Demos/Shader_9_ToonShading/vertex.h", "/Users/mpm/OpenGL-OpenGLES/OpenGL_Demos/Shader_9_ToonShading/fragment.h", 2, GLT_ATTRIBUTE_VERTEX, "vVertex",
    ...
    GLubyte textureData[5][3] = { 32,  0, 0,
                                  64,  0, 32,
                                  96,  32, 0,
                                  128, 0, 32,
                                  255, 0, 0};

    glTexImage1D(GL_TEXTURE_1D, 0, GL_RGB, 5, 0, GL_RGB, GL_UNSIGNED_BYTE, textureData);
